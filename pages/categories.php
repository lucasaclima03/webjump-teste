    ...
    <table class="data-grid">
      ...
      <tr class="data-row">
        <td class="data-grid-td">
           <span class="data-grid-cell-content"><?php echo $item->getNome(); ?></span>
        </td>
      
        <td class="data-grid-td">
           <span class="data-grid-cell-content"><?php echo $item->getCodigo(); ?></span>
        </td>
      
        <td class="data-grid-td">
          <div class="actions">
            <div class="action edit"><a href="editCategory.php?id=<?php echo $item->getId(); ?>"><span>Edit</span></div></a>
            <div class="action delete"><a href="../actions/deletarCategoria.php?id=<?php echo $item->getId(); ?>"><span>Delete</span></div></a>
          </div>
        </td>
        <?php endforeach; ?>
      </tr>      
