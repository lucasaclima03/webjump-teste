...
<!-- Header -->
  ...
  <main class="content">
    ...
    <form method = "POST" action= "../actions/adicionarProduto.php" enctype="multipart/form-data">
      ...
      <div class="input-field">
        ...
        <input type="text" id="price" class="input-text" name = "preco" /> 
      </div>
      <div class="input-field">
        <label for="quantity" class="label">Quantity</label>
        <input type="text" id="quantity" class="input-text" name = "quantidade" /> 
      </div>             
      <div class="input-field">      
        <label for="category" class="label">Categories</label>                
        <select multiple id="category" class="input-text" name="categoria" >
        <?php foreach($categoria as $item): ?> 
        <option><?php  echo $item->getNome();?> </option>       
        <?php endforeach; ?>
        </select>
      </div>             
      <div class="input-field">
