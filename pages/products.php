  ...
  <main class="content">
    ...
    <table class="data-grid">
      ...
      <tr class="data-row">        
        ...
        <td class="data-grid-td">
           <span class="data-grid-cell-content"><?php echo $produto->getCategoria(); ?> <Br /></span>
        </td>        
        <td class="data-grid-td">
          <div class="actions">
            <div class="action edit"><a href="editProduct.php?id=<?php echo $produto->getId(); ?>"> <span>Edit</span></div></a>
            <div class="action delete"><a href="../actions/deletarProduto.php?id=<?php echo $produto->getId(); ?>"><span>Delete</span>            
            </div></a>
          </div>
        </td>        
      </tr>
