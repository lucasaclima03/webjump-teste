...
if($id){
    $item = $categoriaDAO->pegarPeloId($id);
}
?>
<!doctype html>
<html ⚡>
...
<!-- Header -->
  ...
  <main class="content">
    ...
    <form method="POST" action = "../actions/editarCategoria.php" >
    ...
    <div class="input-field">
        ...
        <input type="text" id="category-name" class="input-text" name ="nome" value="<?php echo $item->getNome(); ?>" />
        
      </div>
      <div class="input-field">
        <label for="category-code" class="label">Category Code</label>
        <input type="text" id="category-code" class="input-text" name ="codigo"value="<?php echo $item->getCodigo(); ?>" />
